...
const Title: React.FC<TitleType> = ({ title, description, className }) => (
  <h1 className={`mb-12 max-w-[300px] order-1 sm:mb-16 sm:col-span-2 pt-8 lg:mb-0 lg:max-w-[360px] lg:oder-2 lg:col-span-2 lg:pt-6 lg:pl-7 xl:pl-4 xl:pt-3 2xl:pt-4 2xl:pl-2 2xl:max-w-[400px] 2xl:pl-12 ${className}`} >
