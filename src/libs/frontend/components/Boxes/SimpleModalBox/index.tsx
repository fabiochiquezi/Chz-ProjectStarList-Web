...
const ModalBox: IModalBox = ({ children, closeModal, className }) => (
  ...
  >
    ...
    <div className="flex flex-col mt-[-20px] px-10 py-5 md:py-6 bg-skin-base-primary rounded-lg relative overscroll-y-auto shadow-2xl border-t-8 md:border-t-0 md:border-l-8 border-skin-secondary bg-skin-base-primary">
      {children}
    </div>
  </div>
)
