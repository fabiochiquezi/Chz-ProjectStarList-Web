import { Logo, GithubIcon, DiscordIcon, WhatsAppIcon } from '../../assets'
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto lg:px-4">
                <div
                    className="w-72 mx-auto lg:w-auto flex flex-col justify-center
                    items-center justify-between lg:flex-row lg:items-start 2xl:w-5/6"
                >
                    ...
                    <div className="w-52 xl:w-64 w-52 mb-16 lg:mb-0 order-2 box">
                        <h3
                            ...
                            border-gray-400 border-b-2 pb-4 lg:mb-12"
                        >
                            Links
                        </h3>
                        <ul>
                    ...
                    <div className="w-52 mb-16 xl:w-64 order-1 lg:order-4 box">
                        <h3
                            className="text-3xl font-bold mb-4 border-gray-400
                            border-b-2 pb-4 lg:mb-12"
                        >
                            Follow-me
                        </h3>
                        <ul
                            className="flex mt-8 ml-0 md:mt-16 justify-between
                            items-center w-3/4 left-0 md:w-3/4 mx-auto
                            lg:mt-0 lg:w-auto lg:mx-0 xl:justify-start"
                        >
